    ...
    return(
        ...
        <SafeAreaView style={[Estilo.AppPrincipal, GlobalStyles.AndroidSafeArea]}>
            <View >
                ...
                <Text style={Estilo.txtM}>Que bom te ver aqui! nós iremos te ajudar com o seu novo estilo de vida, te auxiliando com suas refeições, dicas de receitas e sugestões de locais veganos para você fazer suas compras!</Text>
